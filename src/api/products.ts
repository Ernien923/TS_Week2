...
import type { GetProductsResponse, CreateProductResponse, EditProductResponse, DeleteProductResponse, UploadImageResponse } from '@/types/product'
...
export const apiGetProducts = (params): Promise<AxiosResponse<GetProductsResponse>> =>
...
export const apiCreateProduct = (params): Promise<AxiosResponse<CreateProductResponse>> =>
...
export const apiEditProduct = (params): Promise<AxiosResponse<EditProductResponse>> => {
...
export const apiDeleteProduct = (productId): Promise<AxiosResponse<DeleteProductResponse>> =>
...
// - 這是一個 async 函式
export const apiUploadImage = async (file): Promise<AxiosResponse<UploadImageResponse>> =>
